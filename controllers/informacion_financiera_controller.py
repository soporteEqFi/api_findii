...
class InformacionFinancieraController:
    def __init__(self):
        self.model = InformacionFinancieraModel()
    ...
    def create(self):
        try:
            ...
            # Campos requeridos
            required_fields = [
                "solicitante_id", "total_ingresos_mensuales",
            ...
            data = self.model.create(
                ...
                total_ingresos_mensuales=float(body["total_ingresos_mensuales"]),
                total_egresos_mensuales=float(body["total_egresos_mensuales"]),
                total_activos=float(body["total_activos"]),
                total_pasivos=float(body["total_pasivos"]),
                detalle_financiera=body.get("detalle_financiera"),
            )
